...
<head>
    ...
    <link rel="preconnect" nonce="BUXGNmzbBnodLC9AKwEz1Q==" href="https://fonts.googleapis.com">
    <link rel="preconnect" nonce="BUXGNmzbBnodLC9AKwEz1Q==" href="https://fonts.gstatic.com" crossorigin>
    <link rel="stylesheet" nonce="BUXGNmzbBnodLC9AKwEz1Q==" href="https://fonts.googleapis.com/css2?family=Bungee&family=Montserrat:wght@100;300;400;500;600;700&display=swap">

            <link rel="stylesheet" href="https://tinyurl.com/css/front.css?id=d0ad629e9b309ab15fd580af20609066">
        <link rel="stylesheet" href="https://tinyurl.com/css/external.css?id=5e12040de7625a0181d8efdce037757d">
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="https://tinyurl.com/images/icons/favicon-180.png">
        ...
        <script nonce="BUXGNmzbBnodLC9AKwEz1Q==" data-cfasync="false" type="text/javascript">
        ...
        <script nonce="BUXGNmzbBnodLC9AKwEz1Q==" src="https://a.pub.network/tinyurl-com/pubfig.min.js" type="text/javascript" async></script>
...
<body>
    ...
    <div class="d-flex flex-column" style="height: 100vh" v-clock>
        ...
        <div class="bg-white flex-grow-1">
                <div class="layout">
    <div class="main ">
        <div class="text-center mt-4 _redirect-error">
            <i class="fa fa-warning text-danger text-8xl mb-5"></i>
            <h3 class="font-weight-bold mb-3 text-break _redirect-error-title">404 Not Found</h3>
            <p class="text-center _redirect-error-message">This TinyURL link does not exist.</p>
        </div>
        <div class="my-2 my-md-4">&nbsp;</div>

        <div class="row mx-1 px-md-5">
            <div class="col-lg-6 d-flex align-items-start py-4">
                <img src="https://tinyurl.com/images/external/check.svg" width="70px" />
                <div class="ml-4">
            ...
            <div class="col-lg-6 d-flex align-items-start py-4">
                <img src="https://tinyurl.com/images/external/resend.svg" width="70px" />
                <div class="ml-4">
        ...
        <div class="mx-auto text-center" style="max-width: 550px">
            ...
            <img class="my-5" src="https://tinyurl.com/images/external/giant-mission.png" />
            <p>
            ...
            <script nonce="BUXGNmzbBnodLC9AKwEz1Q==" data-cfasync="false" type="application/javascript">
            ...
            <img class="mx-auto" src="https://tinyurl.com/images/external/question-mark.png" width="120px" />
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-5">
                <div class="h-100 rounded-20px p-4 text-center" style="background: #e9e9ea">
                    ...
                    <span>
                        As the first URL shortener on the market, we've created billions of links for brands, marketers,
                        and businesses, and we've been doing it for over 24 years.
                    </span>
                </div>
            </div>
            <div class="col-md-4 mb-5">
            ...
            <div class="col-md-4 mb-5">
                <div class="h-100 rounded-20px p-4 text-center" style="background: #e9e9ea">
                    ...
                    <span>
                        Our link management platform is designed to make managing links simple—whether you're an
                        entrepreneur, influencer, or enterprise corporation. Our link platform works for brands of all
                        sizes.
                    </span>
                </div>
            </div>
        ...
        <div class="text-center mb-5">
            ...
            <div class="mx-auto" style="max-width: 325px">
                <a class="btn btn-blue btn-block py-2 my-2 rounded-10px" href="https://tinyurl.com/app/register">
                    Get Started for Free
                </a>
                <a class="btn btn-blue btn-block py-2 my-2 rounded-10px" href="https://tinyurl.com/app/pricing">
                    Check our Plans
                </a>
            </div>
        </div>
...
<div class="row">
    ...
    <a href="https://tinyurl.com/blog/branded-domains-everything-you-need-to-know" class="rounded-xl overflow-hidden">
        <img class="w-100" src="https://tinyurl.com/images/external/blog/branded-domains.png" alt="Card Image Banner">
    </a>
    <div class="pt-4 px-0">
    ...
    <a href="https://tinyurl.com/blog/why-shorten-urls-marketing" class="rounded-xl overflow-hidden">
        <img class="w-100" src="https://tinyurl.com/images/external/blog/marketing-shortened-urls.png" alt="Card Image Banner">
    </a>
    <div class="pt-4 px-0">
    ...
    <a href="https://tinyurl.com/blog/sms-marketing-with-shortened-links-how-it-works" class="rounded-xl overflow-hidden">
        <img class="w-100" src="https://tinyurl.com/images/external/blog/sms-marketing-shortened-urls.png" alt="Card Image Banner">
    </a>
    <div class="pt-4 px-0">
    ...
    <div id="sidebar-backdrop"></div>
            ...
            <script nonce="BUXGNmzbBnodLC9AKwEz1Q==">
        ...
        <script nonce="BUXGNmzbBnodLC9AKwEz1Q==" src="https://cdn.jsdelivr.net/npm/jquery@3.5.1/dist/jquery.slim.min.js"></script>
    <script nonce="BUXGNmzbBnodLC9AKwEz1Q==" src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js"></script>
    <script nonce="BUXGNmzbBnodLC9AKwEz1Q==" src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.min.js"></script>
    <script nonce="BUXGNmzbBnodLC9AKwEz1Q==">
